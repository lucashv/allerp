...
<input type="hidden" id="idUsuarioLogado" name="idUsuarioLogado" value="<?php $logado = explode(';', $_SESSION['idUSUARIO_LOGADO']); echo $logado[1]; ?>" />
...
function cancelar() {
	...
	// somente se for Usuario Luciane 132 ou Eliane 129 ou clineu 196
	if(idUsuarioLogado == 132 || idUsuarioLogado == 129 || idUsuarioLogado == 196){
		id = document.getElementById('SELECAO').value 
		if (id=='') { alert('Selecione um registro');return;}
...
function cadastro() {
	var idUsuarioLogado = document.getElementById('idUsuarioLogado').value;
	// somente se for Usuario Luciane 132 ou Eliane 129 e Clineu 196
	if(idUsuarioLogado == 132 || idUsuarioLogado == 129 || idUsuarioLogado == 196){
		id = document.getElementById('SELECAO').value 
		if (id=='') { alert('Selecione um registro');return;}
