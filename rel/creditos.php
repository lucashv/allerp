  ...
  <td width="<?php echo $_SESSION['largIFRAME']; ?>" height="<?php echo $_SESSION['altIFRAME']; ?>">
    ...
    style="text-align:left;height:20%;width:70%"    >
      ...
      <tr height="5%"><td>
        ...
        <table WIDTH="100%"><tr  >      
          <td style="width:60%" style="cursor: move;"><span class="lblTitJanela">&nbsp;Créditos e débitos</td>
          ...
          <td style="cursor: pointer;text-align:right;"  
            onclick="window.top.frames['framePRINCIPAL'].location.href='../creditos.php';" 
      ...
      <tr valign="top"  ><td style="height:95%;width:100%" ><table width="100%">
          ...
          onclick="AuxilioF7('txtREL_REPRESENTANTE');"><image src="../images/setaBAIXO.gif"></td>
    		...
    		<tr><td><table>  					
    			<tr>
    				...
    				<td><input type=text id="txtDATAINI" tabindex="2"  maxlength="8" size="10"
    		...
    		<tr><td><table>  					
    			<tr>
    				...
    				<td><input type=text id="txtDATAFIN" tabindex="3"  maxlength="8" size="10"
              onKeyPress="return sistema_formatar(event, this, '00/00/00');"  ></td>
          ...
          <td onmouseover="this.style.backgroundColor='#a9b2ca';this.style.cursor='pointer';"  
            ...
            <input type="radio" id="tipobusca" name="tipobusca" value="1" checked >Data para pagar&nbsp;&nbsp;
          </td>
          <td onmouseover="this.style.backgroundColor='#a9b2ca';this.style.cursor='pointer';"  
            onmouseout="this.style.backgroundColor='#F6F7F7';" onclick="seleciona2(2);">
            <input type="radio" id="tipobusca" name="tipobusca" value="2" >Data de registro&nbsp;&nbsp;
          </td>
    		</table></td></tr>

    		<tr><td>&nbsp;</td></tr>
    		<tr><td><table>
    		  <td width="110px" align="right">Listar:&nbsp;</td>
          <td onmouseover="this.style.backgroundColor='#a9b2ca';this.style.cursor='pointer';"  
            onmouseout="this.style.backgroundColor='#F6F7F7';" onclick="seleciona3(1);">
            <input type="radio" id="tipoREL" name="tipoREL" value="1" checked >Créditos e débitos&nbsp;&nbsp;
          </td>
    		</table></td></tr>
    		<tr><td><table>
          ...
          <td onmouseover="this.style.backgroundColor='#a9b2ca';this.style.cursor='pointer';"  
            ...
            <input type="radio" id="tipoREL" name="tipoREL" value="2" >Todos os vale créditos&nbsp;&nbsp;
          </td>
    		</table></td></tr>
    		<tr><td><table>
    		  <td width="110px" align="right">&nbsp;</td>
          <td onmouseover="this.style.backgroundColor='#a9b2ca';this.style.cursor='pointer';"  
            ...
            <input type="radio" id="tipoREL" name="tipoREL" value="3" >Somente vale créditos NÃO PAGOS&nbsp;&nbsp;
          </td>
    		</table></td></tr>
    		<tr><td><table>
    		  <td width="110px" align="right">&nbsp;</td>
          <td onmouseover="this.style.backgroundColor='#a9b2ca';this.style.cursor='pointer';"  
            ...
            <input type="radio" id="tipoREL" name="tipoREL" value="4" >Somente vale créditos PAGOS&nbsp;&nbsp;
          </td>
    		</table></td></tr>
          ...
          <td onclick="checar();"><input type="checkbox" id="chkSOMATORIA" name="chkSOMATORIA" value="" /></td>
          <td>Não listar, mostrar somatória</td></td>
          <td>&nbsp;&nbsp;&nbsp;&nbsp;</td>         
        </tr>
    		</table></td></tr>
    		...
    		<tr><td><table style="display:none">
  			<tr><td colspan=11><table onmouseover="this.style.backgroundColor='#a9b2ca';this.style.cursor='pointer';"  
          onmouseout="this.style.backgroundColor='#F6F7F7';" onclick="checar();"><tr> 
          <td onclick="checar();"><input type="checkbox" id="chkBAIXAR" name="chkBAIXAR" value="" /></td>
          <td>Registrar pagamento dos vale créditos listados</td></td>
          <td>&nbsp;&nbsp;&nbsp;&nbsp;</td>         
        </tr>
    		</table></td></tr>
...
if  (tecla==27) {e.stopPropagation();e.preventDefault();window.top.frames['framePRINCIPAL'].location.href='../creditos.php';}
...
if (nomeCMP=='todos')         {
  ...
  for( i = 0; i < rdBUTTON.length; i++ ) {
	...
	showAJAX(1);	
	ajax.criar('ajaxRELS.php?acao=creditos&DATAINI=' + DATAINI+'&DATAFIN='+DATAFIN+
        ...
        '&baixar='+document.forms[0].chkBAIXAR.checked, '', 0);
	showAJAX(0);
...
rdBUTTON = document.forms['frmREL'].chkBAIXAR;
