  ...
  <td width="<?php echo $_SESSION['largIFRAME']; ?>" height="<?php echo $_SESSION['altIFRAME']; ?>">
    ...
    style="text-align:left;height:20%;width:70%"    >
      ...
      <tr height="5%"><td>
        ...
        <table WIDTH="100%"><tr  >      
          <td style="width:60%" style="cursor: move;"><span class="lblTitJanela">&nbsp;Contratos sem nenhuma confirmação bancária</td>
      ...
      <tr valign="top"  ><td style="height:95%;width:100%" ><table width="100%">
        ...
        <tr><td><table width="100%" bgcolor='#FFCCCC'>
      		<tr><td><table>
  			    <td style="color:red;font-size:16px">ATENÇÃO</td>
      		</table></td></tr>
            ...
            <tr>
              <td>&nbsp;&nbsp;&nbsp;A data da 1ª mensalidade será igual a data da vigência do contrato.</td>
            </tr>
            <tr>
              <td>&nbsp;&nbsp;&nbsp;<b><font color=blue>Não haverá</font></b> 
                repasse para corretor sobre confirmação da 1ª mensalidade, exceto se quantidade vidas </td>
            </tr>
            <tr>
      		...
      		<tr><td><table>
    				<td>e por isso contratos desta(s) operadora(s) cuja 1a mensalidade foi a única paga, equivalerá a nada ter sido pago</td>
      		</table></td></tr>
...
var aCMPS=new Array();
aCMPS[0]='txtREL_REPRESENTANTE;Identifique um representante válido ou 9999= todos';
aCMPS[1]='txtOPERADORA;Identifique uma operadora válida ou deixe em branco para TODAS';
