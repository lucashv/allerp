  ...
  <td width="<?php echo $_SESSION['largIFRAME']; ?>" height="<?php echo $_SESSION['altIFRAME']; ?>">
    ...
    style="text-align:left;height:20%;width:70%"    >
      ...
      <tr height="5%"><td>
        ...
        <table WIDTH="100%"><tr  >      
          <td style="width:60%" style="cursor: move;"><span class="lblTitJanela">&nbsp;Boletos</td>
      ...
      <tr valign="top"  ><td style="height:95%;width:100%" ><table width="100%">
          ...
          <td onmouseover="this.style.backgroundColor='#a9b2ca';this.style.cursor='pointer';"  
            ...
            <input type="radio" id="tipoREL" name="tipoREL" value="2" >Somente não pagos&nbsp;&nbsp;
          </td>
          <td onmouseover="this.style.backgroundColor='#a9b2ca';this.style.cursor='pointer';"  
            onmouseout="this.style.backgroundColor='#F6F7F7';" onclick="seleciona3(3);">
            <input type="radio" id="tipoREL" name="tipoREL" value="3" >Somente pagos&nbsp;&nbsp;
          </td>
    		</table></td></tr>
...
if (nomeCMP=='todos')         {
  ...
  for( i = 0; i < rdBUTTON.length; i++ ) {
	...
	showAJAX(1);	
	ajax.criar('ajaxRELS.php?acao=boletos&DATAINI=' + DATAINI+'&DATAFIN='+DATAFIN+
