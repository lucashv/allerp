  ...
  <td width="<?php echo $_SESSION['largIFRAME']; ?>" height="<?php echo $_SESSION['altIFRAME']; ?>">
    ...
    style="text-align:left;height:20%;width:70%"    >
      ...
      <tr height="5%"><td>
        ...
        <table WIDTH="100%"><tr  >      
          <td style="width:60%" style="cursor: move;"><span class="lblTitJanela">&nbsp;Cheques</td>
          ...
          <td style="cursor: pointer;text-align:right;"  
            onclick="window.top.frames['framePRINCIPAL'].location.href='../caixa.php';" 
      ...
      <tr valign="top"  ><td style="height:95%;width:100%" ><table width="100%">
          ...
          <td onmouseover="this.style.backgroundColor='#a9b2ca';this.style.cursor='pointer';"  
            ...
            <input type="radio" id="tipoREL" name="tipoREL" value="1" checked>Listar cheques enviados&nbsp;&nbsp;&nbsp;
          </td>

          <td onmouseover="this.style.backgroundColor='#a9b2ca';this.style.cursor='pointer';"  
            onmouseout="this.style.backgroundColor='#F6F7F7';" onclick="seleciona3(2);">
            <input type="radio" id="tipoREL" name="tipoREL" value="2" >Listar cheques recebidos&nbsp;&nbsp;&nbsp;
          </td>

          <td onmouseover="this.style.backgroundColor='#a9b2ca';this.style.cursor='pointer';"  
            onmouseout="this.style.backgroundColor='#F6F7F7';" onclick="seleciona3(3);">
            <input type="radio" id="tipoREL" name="tipoREL" value="3" >Listar todos&nbsp;&nbsp;
          </td>
...
if  (tecla==27) {e.stopPropagation();e.preventDefault();window.top.frames['framePRINCIPAL'].location.href='../caixa.php';}
...
if (nomeCMP=='todos')         {
  ...
  for( i = 0; i < rdBUTTON.length; i++ ) {
	...
	showAJAX(1);	
	ajax.criar('ajaxRELS.php?acao=cheques&DATAINI=' + DATAINI+'&DATAFIN='+DATAFIN+
