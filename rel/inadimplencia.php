  ...
  <td width="<?php echo $_SESSION['largIFRAME']; ?>" height="<?php echo $_SESSION['altIFRAME']; ?>">
    ...
    style="text-align:left;height:20%;width:70%"    >
      ...
      <tr height="5%"><td>
        ...
        <table WIDTH="100%"><tr  >      
          <td style="width:60%" style="cursor: move;"><span class="lblTitJanela">&nbsp;Inadimplência</td>
      ...
      <tr valign="top"  ><td style="height:95%;width:100%" ><table width="100%">
    		...
    		<tr><td><table>  					
    			<tr>
    				<td width="155px" align="right">Produto:  (9999= todos)</td>
    		...
    		<tr><td><table>  					
    			<tr>
    				<td width="155px" align="right">Data Inicial:&nbsp;</td>					
    		...
    		<tr><td><table>  					
    			<tr>
    				<td width="155px" align="right">Data final:&nbsp;</td>					
    		...
    		<tr><td><table>
    		  <tr>
    				<td width="155px" align="right">Buscar por:&nbsp;</td>
            <td onmouseover="this.style.backgroundColor='#a9b2ca';this.style.cursor='pointer';"  
              ...
              <input type="radio" id="tipobusca" name="tipobusca" value="1" checked >Data do vencimento&nbsp;&nbsp;
            </td>
            <td onmouseover="this.style.backgroundColor='#a9b2ca';this.style.cursor='pointer';"  
              onmouseout="this.style.backgroundColor='#F6F7F7';" onclick="seleciona2(2);">
              <input type="radio" id="tipobusca" name="tipobusca" value="2" >Data de cadastro
            </td>
          </tr>  
    		</table></td></tr>
    		...
    		<tr><td><table>  					
    			<tr>
    				<td width="155px" align="right">&nbsp;</td>					
    				<td id=lblBUSCAR><font color=red>Lista propostas com mensalidades vencendo neste período e não pagas </td>            
    		</tr>
    		</table></td></tr>
        
    		<tr><td><table>  					
    			<tr>
    				<td width="155px" align="right">Listar parcelas:</td>
            <td><input type="text" id="txtPARCELA1" tabindex="5"  value="1" maxlength="3" size="6"
                  onKeyPress="return sistema_formatar(event, this, '000');"></td>
            <td>&nbsp;&nbsp;até&nbsp;&nbsp;</td>
            <td><input type="text" id="txtPARCELA2" tabindex="6"  value="500" maxlength="3" size="6"
                  onKeyPress="return sistema_formatar(event, this, '000');"></td>
...
aCMPS[4]='txtPARCELA1;Preencha a 1ª parcela';
aCMPS[5]='txtPARCELA2;Preencha a 2ª parcela (menor ou igual à 1ª)';
...
if (nomeCMP=='todos')         {	
  for (h=0;h<aCMPS.length;h++)   {
    ...
    var label = cCMP.replace('txt', 'lbl');				
        ...
        if ( cVLR=='' )   erro=1;
        if (cCMP=='txtPARCELA2') {
          if ( parseInt(document.getElementById('txtPARCELA1').value, 10) >
              parseInt(document.getElementById('txtPARCELA2').value, 10) )    erro=1;
        }
        break;
  ...
  for( i = 0; i < rdBUTTON.length; i++ ) {
	...
	showAJAX(1);	
	ajax.criar('ajaxRELS2.php?acao=inadimplencia&DATAINI=' + DATAINI+'&DATAFIN='+DATAFIN+
        '&dataIniMostrar='+DATAINIMOSTRAR+'&dataFinMostrar='+DATAFINMOSTRAR+
         '&repre='+document.getElementById('txtREL_REPRESENTANTE').value.trim()+
         '&prod='+document.getElementById('txtTIPO_CONTRATO').value.trim()+
        '&tipobusca='+tipobusca+'&par1='+document.getElementById('txtPARCELA1').value+
         '&par2='+document.getElementById('txtPARCELA2').value, '', 0);
	showAJAX(0);
...
document.getElementById('lblBUSCAR').innerHTML=
  opcao==1 ? 
    '<font color=red>Lista propostas com mensalidades vencendo neste período e não pagas ' :  
    '<font color=red>Lista propostas com data de cadastro neste período e com mensalidades não pagas ';    
}
