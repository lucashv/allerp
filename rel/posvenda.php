  ...
  <td width="<?php echo $_SESSION['largIFRAME']; ?>" height="<?php echo $_SESSION['altIFRAME']; ?>">
    ...
    style="text-align:left;height:20%;width:70%"    >
      ...
      <tr height="5%"><td>
        ...
        <table WIDTH="100%"><tr  >      
          <td style="width:60%" style="cursor: move;"><span class="lblTitJanela">&nbsp;Clientes cadastrados (pós venda)</td>
      ...
      <tr valign="top"  ><td style="height:95%;width:100%" ><table width="100%">
    		...
    		<tr><td><table>  					
    			<tr>
    				<td width="145px" align="right">Produto:</td>
    		...
    		<tr><td><table>  					
    			<tr>
    				<td width="145px" align="right">Corretor: (9999= todos)</td>
    		...
    		<tr><td><table>  					
    			<tr>
    				<td width="145px" align="right">Data Inicial cadastro:&nbsp;</td>					
    		...
    		<tr><td><table>  					
    			<tr>
    				<td width="145px" align="right">Data final cadastro:&nbsp;</td>					
...
if (nomeCMP=='todos')         {	
  ...
  DATAFIN = '20'+DATAFIN.substring(6, 10)+DATAFIN.substring(3, 5)+DATAFIN.substring(0, 2);
	...
	showAJAX(1);	
	ajax.criar('ajaxRELS2.php?acao=posvenda&DATAINI=' + DATAINI+'&DATAFIN='+DATAFIN+
