...
IF ($acao=='lerREGS') {
  ...
  $largura1 = $_SESSION['largIFRAME'] * 0.15;
  $largura3 = $_SESSION['largIFRAME'] * 0.2;
  $largura4 = $_SESSION['largIFRAME'] * 0.25;    
  $largura5 = $_SESSION['largIFRAME'] * 0.1;
    
	$header = "$largura5 px,Operadora|$largura1 px,Data/hora|$largura5 px,Operador responsável|$largura1 px,Nome do arquivo|".
             "$largura5 px,Erros|$largura5 px,Baixas|$largura5 px,Estornos|$largura3 px,Período apuração";
  ...
  while ($row = mysql_fetcH_object($resultado)) {
    if ($i==1) {
      ...
      $largura1='';$largura3=''; $largura4=''; $largura5='';
    }
    $i++;
    ...
    $lin = "<tr @mudaCOR ondblclick=\"editarREG();\" onmousedown=\"Selecionar(this.id);\" id=\"$row->numREG\" onmouseover=\"this.style.cursor='default';" .  
            ...
            "<td align=\"left\" $largura5>&nbsp;&nbsp;$row->nomeOPERADORA ($row->idoperadora)</td>".
            "<td align=\"left\" $largura1>$row->dataMOSTRAR</td>".
            "<td align=\"left\" $largura5>$row->nomeOPERADOR ($row->idOPERADOR)</td>".
            "<td align=\"left\" $largura1>$row->nomearq</td>".            
            "<td align=\"right\" $largura5>$qtdeERROS</td>".
            "<td align=\"right\" $largura5>$qtdeBAIXAS</td>".
            "<td align=\"right\" $largura5>$qtdeESTORNOS</td>".
            "<td align=\"left\" $largura3>&nbsp;&nbsp;$row->periodoAPURACAO</td>".
            "</tr>";
