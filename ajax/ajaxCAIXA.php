...
if ($acao=='lerESCRITORIOS') {
  ...
  for ($rr=0; $rr<strlen($row->escritorios); $rr++) {
	...
	if ($letraESCRITORIO=='K') $codigo=11;
	if ($letraESCRITORIO=='L') $codigo=12;
	if ($letraESCRITORIO=='M') $codigo=13;
	if ($letraESCRITORIO=='N') $codigo=14;
	if ($letraESCRITORIO=='O') $codigo=15;
	if ($letraESCRITORIO=='P') $codigo=16;
	if ($letraESCRITORIO=='Q') $codigo=17;
        if ($letraESCRITORIO=='R') $codigo=18;
