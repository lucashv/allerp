...
//  die($lendoATUAL);
  ...
  if ( isset($_REQUEST['vlr2']) ) {
    ...
    if (! is_numeric($vlr2) ) {
		// Se primeiro caracter for # busca pelo id da indicação
		if(substr($vlr2, 0, 1) == '!'){
			$buscaEspecial = str_replace("!", "", $vlr2);
			$sql=str_replace('@criterioBUSCA', " lig.numREG = $buscaEspecial ",$sql);
			$filtro="somente numREG = $buscaEspecial";
		}else{
