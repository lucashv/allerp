    ...
    <script language="javascript" type="text/javascript" xml:space="preserve">
        ...
        function tudoOK() {
            ...
            if (buscaAjax.terminouLER()) {
                ...
                info = info.replace(String.fromCharCode(13), '');
                info = info.replace(String.fromCharCode(10), '');
                info = info.replace(String.fromCharCode(13), '');
                info = info.replace(String.fromCharCode(10), '');
                info = info.replace(String.fromCharCode(13), '');
                info = info.replace(String.fromCharCode(10), '');
        ...
        function Sair() {
            if (confirm('Sair do sistema?'))
                sairPROGRAMA();   //sai = new execAjax('ajax/ajax.php?acao=sairPROGRAMA', "sairPROGRAMA");
        }
