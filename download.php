...
Software para confirmações<br><br>
Clique (COM O BOTÃO DIREITO DO MOUSE)<a target="_blank" href="confirmacoes.exe"> aqui</a> e escolha "Salvar link como..."
<br><br><br><br>
<span style="font-size:24px;color:grey;font-family:verdana;">
Salve-o em qualquer pasta, execute-o...<br><br>
<br><br>
<font color="red">CUIDADO:</font> Com este programa qualquer pessoa pode fazer confirmações de pagamentos. 
</span>  
