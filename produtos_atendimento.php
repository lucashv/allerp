...
var aCMPS=new Array();
aCMPS[0]='txtNOME;Digite a descrição do produto';
...
ajax.criar('ajax/ajaxPRODUTOS_ATENDIMENTO.php?acao=lerREGS&ativos='+
...
if ( ajax.terminouLER() ) {
  ...
  titulo.innerHTML = '&nbsp;&nbsp;<font size="+1">Produtos dos atendimentos</font>&nbsp;&nbsp;&nbsp;&nbsp;';
...
function incluirREG() {
showAJAX(1);
ajax.criar('ajax/ajaxPRODUTOS_ATENDIMENTO.php?acao=incluirREG', desenhaJanelaREG);
}
...
showAJAX(1);
ajax.criar('ajax/ajaxPRODUTOS_ATENDIMENTO.php?acao=editarREG&vlr=' + id, desenhaJanelaREG);
}
...
if (nomeCMP!='todos')         {
  ...
  /* tudo ok, aciona gravacao do registro, concatena campos em uma variavel */
	showAJAX(1);
	ajax.criar('ajax/ajaxPRODUTOS_ATENDIMENTO.php?acao=gravar&vlr=' + cmps, gravou);
}
...
ajax.criar('ajax/ajaxPRODUTOS_ATENDIMENTO.php?acao=mudarSITUACAO&vlr=' + id, '', 0);
