  ...
  <td width="<?php echo $_SESSION['largIFRAME']; ?>" height="<?php echo $_SESSION['altIFRAME']; ?>">
    ...
    <table cellspacing="0" cellpadding="0" border="1" width="75%" bgcolor="white" style="text-align:left;">
      ...
      <tr><td><table width="100%" cellpadding="0" cellspacing="2"><tr>
        <td width="80%"><span class="lblTitJanela" id="lblTITULO">&nbsp;&nbsp;Municípios</span></td>
...
aCMPS[0]='txtNOME;Digite o nome do município';
aCMPS[1]='txtUF;Identifique a UF do município';
...
if ( ajax.terminouLER() ) {
  ...
  titulo.innerHTML = '&nbsp;&nbsp;<font size="+1">Municípios</font>&nbsp;&nbsp;&nbsp;&nbsp;';
