    ...
    _show : function (e) {
        ...
        if (menuElementId) {
            ...
            SimpleContextMenu._menuElement.style.top =  m.y + s.y + 'px';
						SimpleContextMenu._menuElement.style.visibility = 'visible';
            SimpleContextMenu._menuElement.style.display = 'block';
            SimpleContextMenu._menuElement.style.zIndex= 60;            
            
            
//            alert(SimpleContextMenu._menuElement.style.left + ',' +SimpleContextMenu._menuElement.style.top);
