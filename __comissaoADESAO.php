...
.cssDIV_VALORES {
position: absolute; top: 200px;  width: 500px; height: 60px;	
margin-top: -280px; margin-left: -240px; display:block; z-index:3;}
...
divVALORES.innerHTML = ajax.ler();
divVALORES.setAttribute(propCLASSE, 'cssDIV_VALORES');    
